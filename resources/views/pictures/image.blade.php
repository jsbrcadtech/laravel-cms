...
<section class="w3-padding">
    ...
    <div class="w3-margin-bottom">
        @if($picture->image)
            <img src="{{asset('storage/images/'.$picture->image)}}" width="200">
        @endif
    </div>

    <form method="post" action="/console/pictures/image/{{$picture->id}}" novalidate class="w3-margin-bottom" enctype="multipart/form-data">
